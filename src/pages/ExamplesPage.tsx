...
const features = [
    ...
    { number: "30", name: "Cortex Training", folder: "30-cortex-training" },
    { number: "31", name: "Email Tracking", folder: "31-email-tracking" },
    { number: "32", name: "AI Cost Monitoring", folder: "32-ai-cost-monitoring" },
    { number: "33", name: "Ingestion", folder: "33-ingestion" },
    { number: "34", name: "User Telemetry", folder: "34-user-telemetry" },
    { number: "35", name: "Team Management", folder: "35-team-management" },
    { number: "36", name: "Audit Logs", folder: "36-audit-logs" },
    { number: "37", name: "Rate Limiting", folder: "37-rate-limiting" },
    { number: "38", name: "Failover", folder: "38-failover" },
    { number: "39", name: "Model Routing", folder: "39-model-routing" },
    { number: "40", name: "Cost Optimization", folder: "40-cost-optimization" },
    { number: "41", name: "Alerts", folder: "41-alerts" },
    { number: "42", name: "Reports", folder: "42-reports" },
    { number: "43", name: "Integrations", folder: "43-integrations" },
];
