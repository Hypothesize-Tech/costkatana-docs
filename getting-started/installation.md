...
1. **Create Account**
   ...
   https://app.costkatana.com/register
...
5. **Test Connection**
   ...
   curl -H "X-API-Key: ck_user_your_key_here" \
        https://api.costkatana.com/api/health
   ```
...
client = CostKatana(
    api_key=os.getenv('API_KEY'),
    base_url='https://api.costkatana.com',  # optional
...
- 💬 **Discord**: [#installation-help](https://discord.gg/costkatana)
...
5. **[Join the Community](https://discord.gg/costkatana)** - Get help and share tips
